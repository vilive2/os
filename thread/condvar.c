...
*   while the third watches the value of "count". When "count"
...
* SOURCE: Adapted from example code in "Pthread Programming", B. Nichols
...
void *watch_count(void *t) {
    ...
    will automatically and atomically unlock mutex white it waits.
